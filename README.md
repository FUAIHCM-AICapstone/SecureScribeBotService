...
An open-source automation bot for joining and recording video meetings across multiple platforms including Google Meet. Built with TypeScript, Node.js, and Playwright for reliable browser automation.

## ✨ Features

- **Multi-Platform Support**: Join meetings on Google Meet
...

{
  ...
  "url": "https://meet.google.com/obr-ympj-vcs",
...
- **Sign-in Required**: Meetings that require users to sign in to the platform (Google) before joining
